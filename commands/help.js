...
/**
 * /help — Browse the 718 CenzoJS built-in functions by category.
 * Shows a select menu; pick a category to see all functions in it.
 * Companion handler: commands/helpselect.js
 */
module.exports = {
  name:        'help',
  description: 'Browse all 718 CenzoJS functions by category',
  slash:       true,
  ephemeral:   false,
  ...
  code: [
    ...
    '$description[**718 built-in functions** organised into 30+ categories.$newlineSelect a category below to view every function in it, or use `!find <name>` to search for a specific one.]',
    ...
    '$addField[⚡ Available Categories (25 shown);🔵 Discord  📨 Message  🔨 Moderation  🎭 Roles  📢 Channels$newline📦 Variables  🗄️ Database  🔀 Control  🔣 Logic  🔢 Math$newline🔤 Strings  🖼️ Embeds  🧩 Components  🕐 Time  ⏳ Cooldown$newline😀 Reactions  🎲 Random  🌐 HTTP  🪝 Webhooks  🧵 Threads$newline🔐 Permissions  🔊 Voice  📋 JSON  🤖 AI  ⚡ Slash;false]',
    ...
    '$footer[CenzoJS v2.0 • 718 functions • Select a category above]',
    '$timestamp',
  ].join('\n'),
};
